...
namespace Huanlin.Common.Cryptography
{
    ...
    public class HashCrypto
    {
        ...
        private ByteArray _HashValue = new ByteArray();
        ...
        /// </summary> 
        public ByteArray Calculate(ref System.IO.Stream s)
        {
        ...
        /// </summary> 
        public ByteArray Calculate(ByteArray d)
        {
        ...
        /// </summary> 
        public ByteArray Calculate(ByteArray d, ByteArray salt)
        {
        ...
        /// </summary> 
        private ByteArray CalculatePrivate(byte[] b)
        {
        ...
        private class CRC32 : HashAlgorithm
        {
            ...
            protected override void HashCore(byte[] array, int ibStart, int cbSize)
            {
                ...
                for (int i = ibStart; i <= cbSize - 1; i++)
                {
                    ...
                    result = (uint) ((result & -256) / 256) & 16777215;
            ...
            {
                byte[] b = BitConverter.GetBytes(result ^ 0xffffffff);
                Array.Reverse(b);
                return b;
            }
